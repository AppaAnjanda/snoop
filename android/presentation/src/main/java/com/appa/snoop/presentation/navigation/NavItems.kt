...
import com.appa.snoop.presentation.navigation.Router.MAIN_LOGIN_ROUTER_NAME
...
import com.appa.snoop.presentation.navigation.Router.Title.MAIN_LOGIN
...
//    object Login : MainNav(MAIN_LOGIN_ROUTER_NAME, R.drawable.ic_home, MAIN_LOGIN)

    companion object {
        fun isMainRoute(route: String?): Boolean {
            return when (route) {
                MAIN_HOME_ROUTER_NAME, MAIN_CATEGORY_ROUTER_NAME,
                MAIN_LIKE_ITEM_ROUTER_NAME, MAIN_MY_PAGE_ROUTER_NAME, -> true
//                MAIN_LOGIN_ROUTER_NAME -> true
...
object LoginNav : Destination {
    ...
    override val title: String = Router.Title.MAIN_LOGIN
}
