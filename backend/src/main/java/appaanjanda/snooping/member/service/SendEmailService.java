...
import appaanjanda.snooping.member.util.EncryptionUtils;
...
public class SendEmailService {
	...
	public MailDto createMailAndChangePassword(ChangePasswordRequestDto requestDto) {
		String str = getTempPassword();
		MailDto dto = MailDto.builder()
			.title(requestDto.getName() + "님의 AppaAnjanda 임시비밀번호 안내 이메일 입니다.")
			.message("안녕하세요. AppaAnjanda 임시비밀번호 안내 관련 이메일 입니다." + "[" + requestDto.getName() + "]" + "님의 임시 비밀번호는 "
				+ str + " 입니다.")
